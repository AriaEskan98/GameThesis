...
#define GE_ADD_INTERNAL_CALL(Name) mono_add_internal_call("GameEngine.InternalCalls::" #Name, Name)
	...
	{
		GE_CORE_WARN("Value: {0}", *parameter);
	...
	static MonoString* TextComponent_GetText(UUID entityID)
	{
		...
		Entity entity = scene->GetEntityByUUID(entityID);
		GE_CORE_ASSERT(entity);
		GE_CORE_ASSERT(entity.HasComponent<TextComponent>());
	...
	void ScriptGlue::RegisterFunctions()
	{
		...
		GE_ADD_INTERNAL_CALL(TextComponent_GetText);
		GE_ADD_INTERNAL_CALL(TextComponent_SetText);
		GE_ADD_INTERNAL_CALL(TextComponent_GetColor);
		GE_ADD_INTERNAL_CALL(TextComponent_SetColor);
		GE_ADD_INTERNAL_CALL(TextComponent_GetKerning);
		GE_ADD_INTERNAL_CALL(TextComponent_SetKerning);
		GE_ADD_INTERNAL_CALL(TextComponent_GetLineSpacing);
		GE_ADD_INTERNAL_CALL(TextComponent_SetLineSpacing);
